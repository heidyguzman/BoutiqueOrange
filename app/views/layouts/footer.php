    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div>
        ...
        <ul class="space-y-1">
          ...
          <li><a href="index.php?controller=foro&action=index" class="underline">Foro</a></li>
          <li><a href="nosotros.php" class="hover:underline">Preguntas Frecuentes</a></li>
        </ul>
      </div>
      <div>
      ...
      <div>
        ...
        <p>Correo: <a href="mailto:Orange.colima@" class="underline">Orange.colima@hotmail.com</a></p>
